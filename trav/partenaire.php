...
<body>
    ...
    <section id="about-particuliers" class="about-section">
        <div class="container">
            <div class="feature">
                <h2><?php echo $lang['about_partenaire_title']; ?></h2>
                <p><?php echo $lang['about_particuliers_description']; ?></p>
            </div>
            <div class="feature">
                <h3>Uber/Bolt</h3>
                <p><?php echo $lang['uber_description']; ?></p>
            </div>
            <div class="feature">
                <h3>Ibis Hotel/Air bnb</h3>
                <p><?php echo $lang['ibis_hotel_description']; ?></p>
            </div>
            <div class="feature">
                <h3>BlaBlaCar</h3>
                <p><?php echo $lang['blablacar_description']; ?></p>
            </div>
    </section>
